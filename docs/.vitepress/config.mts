...
export default defineConfig({
  ...
  base: '/viselect/',
  description:
    'Viselect - A high performance and lightweight library to add a visual way of selecting elements, just like on your Desktop. Zero dependencies.',
  head: [
    // SEO
    [
      'meta',
      {
        name: 'keywords',
        content: 'viselect, select, selectbox, selectize, selectize, typescript, simonwep'
      }
    ],
    [
      'meta',
    ...
    [
      ...
      {
        property: 'og:image',
        content: 'https://simonwep.github.io/viselect/cover.png'
      }
    ],
    ...
    [
      'meta',
      {
        ...
        content: 'The cover of Viselect featuring the name and a subheader on a solid white background.'
      }
    ],
    [
      'meta',
    ...
    [
      'script',
      {
        ...
        'data-website-id': 'f2c623d2-5353-4dc5-acc5-d6979536958a'
      }
    ],
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/simonwep/viselect' }],
    footer: {
