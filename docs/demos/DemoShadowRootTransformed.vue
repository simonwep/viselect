<template>
  <div>
    ...
    <p>
      This demo shows selection functionality within a Shadow DOM with transformed/zoomed elements. The canvas is zoomed
      and translated, and elements can overflow outside the canvas boundaries.
    </p>
...
const createShadowDOM = (host: HTMLElement, status: unknown, config: unknown) => {
  // Create shadow root
